from gpt_researcher import ExtendGPTResearcher, ExtConfig
...
class ResearchAgent:
    ...
    async def research(self, query: str, research_report: str = "research_report",
        ...
        researcher = ExtendGPTResearcher(query=query, cfg = ExtConfig(), report_type=research_report, parent_query=parent_query,
